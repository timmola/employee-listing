...
?>
	<section class="side-menu fixed left">
		<div class="logo"><img src="images/logos.png"></a></div>		
			<p>Employee Listing Portal </p>
		</div>
		<ul class="nav">
			<li class="nav-item current"><a href="../dashboard"><span class="nav-icon"><i class="fa fa-users"></i></span>All Listed Employees</a></li>
			...
			<?php if($usertype == "Admin"){ ?>
				<li class="nav-item"><a href="../dashboard/add_employee.php"><span class="nav-icon"><i class="fa fa-user-plus"></i></span>List New Employee</a></li>
			...
			<div class="wrapper employee_list clearfix">
				...
				<ul class="emp_list">
					<li class="emp_list_head">
						...
						<div class="emp_item_head emp_dir">Reason for Listing</div>
										...
										if($usertype == "Admin"){
											...
											echo '										
												<li class="emp_item">
													...
													<div class="emp_column">'.$job_type.'</div>
													<div class="emp_column emp_status">'.$status.'</div>
													<div class="emp_column emp dir">'.$residence_direction.'</div>
														<ul class="action_list">
															<li class="action_item action_view" data-id="'.$id.'" title="View"><i class="fa fa-eye"></i></li>
														</ul>
													</div>
										...
										if($usertype == "Admin"){
											echo '										
												<li class="emp_item">
													...
													<div class="emp_column">'.$job_type.'</div>
													<div class="emp_column emp_status">'.$status.'</div>
													<div class="emp_column emp_dir">'.$residence_direction.'</div>
														<ul class="action_list">
															<li class="action_item action_view" data-id="'.$id.'" title="View"><i class="fa fa-eye"></i></li>
															<li class="action_item action_edit" data-id="'.$id.'" title="Edit"><i class="fa fa-pencil-square-o"></i></li>
															<li class="action_item action_delete" data-id="'.$id.'" title="Delete"><i class="fa fa-trash-o"></i></li>
											...
											echo '										
												<li class="emp_item">
													...
													<div class="emp_column">'.$job_type.'</div>
													<div class="emp_column emp_status">'.$status.'</div>
													<div class="emp_column residence_direction">'.$residence_direction.'</div>
													<div class="emp_column">
														<ul class="action_list">
															<li class="action_item action_view" data-id="'.$id.'" title="View"><i class="fa fa-eye"></i></li>
														</ul>
